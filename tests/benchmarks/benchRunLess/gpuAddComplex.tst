...
function bench()
    ...
    abs_path = get_absolute_file_path("gpuAddComplex.tst");
    fileName = abs_path + "benchData/addcomplex.h5";
    ...
    saveMyBench(fileName,"Scilab - Matrix complex addition","Data Size (Million of elements)","Computation Time (milliseconds)",dataSize,computeTime,["Intel Xeon CPU E5410 @ 2.33GHz", "Nvidia GTX 560 Ti", "Data transfert CPU to GPU", "GPU Computation","Data transfert GPU to CPU"]);
